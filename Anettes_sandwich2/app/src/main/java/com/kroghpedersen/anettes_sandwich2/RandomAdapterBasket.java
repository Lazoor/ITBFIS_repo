...
public class RandomAdapterBasket extends BaseAdapter {

    Context context;
    List<ChoiceObj> ChoiceObjs;
    ChoiceObj choiceObj;

    public RandomAdapterBasket(Context context, List<ChoiceObj> uploadDTOs)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null )
        {
            ...
            convertView = layoutInflater.inflate(R.layout.choice_item_basket,null);
        }
