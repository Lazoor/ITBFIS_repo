...
public class Menu9_paymentpick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choiceObjList.add(new ChoiceObj("Kredit Kort", BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.stadard)));
        choiceObjList.add(new ChoiceObj("betaler med seksuelle tjenester", BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.stadard)));
        choiceObjList.add(new ChoiceObj("Kontant", BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.stadard)));
        choiceObjList.add(new ChoiceObj("Vouchers", BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.stadard)));
